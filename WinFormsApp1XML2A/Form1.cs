    ...
    public partial class Form1 : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show("XML файл успішно створено.", "Виконано.");
            }
            catch
            {
                MessageBox.Show("Неможливо створити XML файл.", "Помилка.");
            }
        }
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Очистити поле перед загрузкою нового файла.", "Помилка.");
            }
            else
            {
